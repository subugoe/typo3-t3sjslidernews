...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPlugin([
    ...
    $_EXTKEY.'_pi1',
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::siteRelPath($_EXTKEY).'ext_icon.gif',
], 'list_type');

\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue($_EXTKEY.'_pi1', 'FILE:EXT:'.$_EXTKEY.'/Resources/Private/FlexForms/flexform_ds.xml');
